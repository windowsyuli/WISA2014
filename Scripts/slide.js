...
if (isUndefined(sliderun)) {
    ...
    function slide() {
        ...
        s.loadImage = function () {
            ...
            getid('outer_' + s.slideId).onclick = s.imageLink;
            for (i = 1; i < s.imgnum; i++) {
                ...
                getid('switch_' + s.slideId).appendChild(switchdiv);
        ...
        s.loadCheck = function () {
            ...
            if (s.imgLoaded < s.imgnum - 1) {
                getid('percent_' + s.slideId).innerHTML = (parseInt(s.imgLoad.length / s.imgnum * 100)) + '%';
        ...
        s.showImage = function (i) {
            ...
            if (s.prevImg) {
                getid('switch_' + s.prevImg + '_' + s.slideId).style.backgroundColor = s.slideSwitchbgColor;
            }
            getid('switch_' + s.currentImg + '_' + s.slideId).style.backgroundColor = s.slideSwitchHiColor;
            getid('slide_' + s.slideId).innerHTML = '';
            getid('slide_' + s.slideId).appendChild(s.imgLoad[s.currentImg]);
